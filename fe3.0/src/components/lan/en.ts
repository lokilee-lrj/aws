export const en = {
  ...
  home: {
    card: [
      ...
      {
        title: "Sustainable alternatives to crop residue burning for farmers",
        p1: "Crop residue burning is a traditional method of agricultural waste disposal that can quickly clear fields but poses potential risks to the environment and human health. As a result, many countries are advocating for a reduction or ban on such practices. Below are some safe and environmentally friendly recommendations to help farmers better manage post-harvest crop residues:",

        p2: [
          "Returning Crop Residues to the Soil:",
          "Method: Shred the residues and spread them evenly back onto the fields as organic fertilizer. This not only improves soil structure and fertility but also increases the organic content of the soil.",
          "Benefits: Prevents air pollution caused by burning and enhances the soil's water retention capacity and microbial activity.",
        ],
        p3: [
          "Composting Crop Residues:",
          "Method: Mix crop residues with animal manure and other organic materials to compost, undergoing fermentation.",
          "Benefits: Converts into high-quality organic fertilizers for use in fields, reducing reliance on chemical fertilizers.",
        ],
        p4: [
          "Biomass Energy:",
          "Method: Use crop residues as raw materials for biomass energy production, such as biomass pellets or direct biomass power generation.",
          "Benefits: Transforms into a sustainable energy source, decreasing fossil fuel use and promoting sustainable energy development.",
        ],
        p5: [
          "Crop Residues as Feed:",
          "Method: Process the residues through techniques such as desilication and fermentation to convert them into livestock feed.",
          "Benefits: Provides a low-cost feed resource for livestock, increasing farmers' economic returns.",
        ],
        p6: [
          "Industrial Materials from Crop Residues:",
          "Method: Utilize crop residues in the manufacture of paper, bioplastics, building materials, etc.",
          "Benefits: Offers a renewable resource, reducing reliance on traditional wood and fossil resources.",
        ],
        p7: [
          "Safe Burning Measures (if burning is necessary):",
          "Preventive Measures: Conduct burning on suitable weather days, avoiding windy and dry conditions.",
          "Implementation: Establish firebreaks around the burning area to keep the boundaries clear and controlled.",
          "Firefighting Preparedness: Prepare adequate firefighting tools onsite, such as water sources, sand, and fire extinguishers, to respond immediately if the fire becomes uncontrolled.",
        ],
        p8: "By implementing these methods, not only can farmers effectively manage crop residues, but they can also protect the environment and reduce impacts on ecosystems. More importantly, these practices can enhance the overall value and quality of crops, leading to a more sustainable agricultural future.",
      },
      {
        title: "Escape plan",
        p1: [
          "Families that are properly prepared are more likely to evacuate their homes safely and calmly.",
        ...
        p7: "Useful tips for parents",
        p8: [
          "Turn it into a game by timing how quickly they can escape",
          "Make sure children know their home address and how to call Triple Zero (000) (000)",
      ...
      {
        title: "Barbecue fire safety",
        p1: "Barbecues are a great way to enjoy time with friends and family, but safety should always come first.",
        p2: "Before starting your barbecue, take the following precautions:",
        p3: [
          "1.	Inspect the LP gas cylinder before use. Do not refill cylinders that have not been tested in over ten years or that show signs of damage. Opt for a reputable cylinder exchange service to guarantee safety.",
  ...
  information: {
    ...
    tabItems: [
      ...
      },
      {
        ...
        introduction:
          "Preventing bushfires is a crucial environmental and public safety concern, especially in regions prone to such natural disasters. Effective bushfire prevention involves a combination of community effort, government regulation, and individual actions. Here are some key strategies to help prevent bushfires:",
        p1: {
      ...
      },
      {
        ...
        p1: {
          title: "Burning",
          content:
            "Agricultural activities in which people may intentionally burn forest land to clear land, plant crops, or maintain pasture. This burning can sometimes get out of control, sparking wider forest fires.",
        },
        p2: {
          title: "Campfires and Fireworks",
          content:
            "Failure to properly extinguish campfires while camping or the use of fireworks and other flammable items in wooded areas are also common causes of forest fires.",
        },
        p3: {
          title: "Electrical facilities",
          content:
            "Failures in power lines or facilities, such as sparks caused by downed wires or equipment malfunctions, may also ignite forest fires.",
        },
        p4: {
          title: "Burning of garbage and debris",
          content:
            "Burning garbage or debris near forested areas, especially under windy and dry conditions, can also easily cause fires.",
        },
        p5: {
          title: "Vandalism",
          content:
            "Intentional arson is also an important human factor in forest fires.",
        },
      },
    ],
  },
  ...
  quiz: {
    ...
    right: "Right!",
    wrong: "It's wrong!",
    congratulation: "Great, we have finished all the questions!",
        ...
        p: [
          {
            title: "",
            content:
              "Byte Blazers was founded in 2024 by a group of final-year students at Monash University. Alarmed by the increasing severity and frequency of bushfires linked to climate change, we were driven to create an educational platform that serves university students—the emerging leaders poised to confront these environmental challenges.",
          },
        ],
      },
      {
        ...
        p: [
          {
            title: "",
            content:
              "As final-year students, we understand the importance of practical knowledge. We are dedicated to preparing ourselves and our peers for the future by turning theoretical study into actionable insights that can address real-world problems like climate change and bushfires.",
          },
        ],
      },
      {
        ...
        p: [
          {
            title: "",
            content:
              "Engage with Byte Blazers as we transform knowledge into action. For more resources, collaborative opportunities, and community initiatives, visit our Resources page and follow us on Facebook, Twitter, and Instagram. Together, we can make a significant impact.",
          },
        ],
      },
    ],
